const apiURL = '//api.openweathermap.org/data/2.5/weather?id=5607916&APPID=8e9c64fa57cc9617996fe2f6b39a853d&units=imperial';
  ...
  fetch(prestonURL)
      ...
      .then(function (jsonObject) {
          ...
          home.forEach(town => {
              ...
              document.getElementById('eventsss').appendChild(card);            
          });
      });
